...
HACKATHON_APP_DEADLINE = timezone.datetime(2019, 2, 22, 23, 59, tzinfo=timezone.pytz.timezone(TIME_ZONE))
...
# (OPTIONAL) When to arrive at the hackathon
HACKATHON_LEAVE = 'Closing ceremony will be held on Sunday February 24th from 3:00 PM to 4:00 PM. ' \
